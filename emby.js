...
export default {
  ...
  buildPublicPage(config) {
      ...
      return '<!DOCTYPE html><html lang="zh-CN"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"><meta name="theme-color" content="#dce8fb"><title>Emby Status</title><style>' +
          ...
          '<footer class="public-footer"><a href="https://github.com/pototazhang/emby-js" target="_blank" rel="noopener noreferrer">Open source: github.com/pototazhang/emby-js</a></footer>' +
          '</main></body></html>';
  },
  ...
  buildServerCardSvg(server, config = {}) {
      ...
      return '<?xml version="1.0" encoding="UTF-8"?><svg xmlns="http://www.w3.org/2000/svg" width="760" height="420" viewBox="0 0 760 420" preserveAspectRatio="xMidYMid meet" role="img">' +
          ...
          '<a href="https://github.com/pototazhang/emby-js" target="_blank" rel="noopener noreferrer"><text x="650" y="314" text-anchor="end" font-family="system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif" font-size="9" font-weight="700" fill="#94a3b8">' + this.escapeSvgText('github.com/pototazhang/emby-js') + '</text></a>' +
          '</g></svg>';
  },
